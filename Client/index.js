...
function getFood() {
  axios
    .get(dataServiceBaseUrl + "/api/food")
    .then((response) => {
...
function getFoodById(id) {
  axios
    .get(dataServiceBaseUrl + `/api/food/${id}`)
    .then((response) => {
      console.log("Success: ", response.data);
    })
    .catch((error) => {
...
function getFoodByNameAndPrice(name, price) {
  axios
    .get(dataServiceBaseUrl + `/api/food?name=${name}&price=${price}`)
    .then((response) => {
      console.log("Success: ", response.data);
    })
    .catch((error) => {
...
function addFood(ime, kategorija, cijena, sastojci) {
  ...
  axios
    .post(dataServiceBaseUrl + "/api/food", postData, { headers: headers })
    .then((response) => {
      console.log("Success: ", response.data);
    })
    .catch((error) => {
...
function changeFood(id, ime, kategorija, cijena, sastojci) {
  ...
  axios
    .put(dataServiceBaseUrl + `/api/food/${id}`, changeFood)
    .then((response) => {
      console.log("Success: ", response.data);
    })
...
function changePartOfFoodInfo(id, updateData) {
  ...
  axios
    ...
    .then((response) => {
      ...
      axios
        .put(`${dataServiceBaseUrl}/api/food/${id}`, currentFoodData)
...
function deleteFood(id) {
  axios
    .delete(dataServiceBaseUrl + `/api/food/${id}`)
    .then((response) => {
      console.log("Success: ", response.data);
    })
    .catch((error) => {
